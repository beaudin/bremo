...
//		LittleHelpers.print_Hash(INPUTFILE_PARAMETER);
	...
	/**
	 * Mit dieser Methode wird die nächste Rechenzeit zurückgegeben.
	 * Diese Zeit entspricht dem nächsten ganzen Rechenzeitschritt und
	 * nicht einem vom RungeKutta-Verfahren verwendeten Zwischenschritt.
	 */
...
//		und dann noch die umrechnung der Zeit mit convert_KW2SEC. 
	 ...
	 * Brennraumdachhöhe genannt und wird in dem Wandwärmemodell von Chang (HCCI) verwendet.
	 */
