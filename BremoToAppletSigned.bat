...
rem echo ------------------------------
rem jarsigner -verbose signedjar Applet/jcommon-1.0.18.jar bibliothek/jcommon-1.0.18/jcommon-1.0.18.jar "das software-sicherheitsmodul:karlsruhe institute of technology id von grp: softwareentwicklung am ifkm" -keystore D:/Daten/Zertifikat/BREMO.p12 -storetype pkcs12
rem jarsigner -verbose signedjar Applet/jfreechart-1.0.15.jar bibliothek/jfreechart-1.0.15/jfreechart-1.0.15.jar "das software-sicherheitsmodul:karlsruhe institute of technology id von grp: softwareentwicklung am ifkm" -keystore D:/Daten/Zertifikat/BREMO.p12 -storetype pkcs12
