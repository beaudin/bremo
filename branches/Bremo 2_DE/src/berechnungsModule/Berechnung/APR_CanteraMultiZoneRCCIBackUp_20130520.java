...
public class APR_CanteraMultiZoneRCCIBackUp_20130520 {	
//public class APR_CanteraMultiZoneRCCIBackUp_20130520 extends APR_Cantera {		
//	private Motor motor;
...
//
//
//	protected APR_CanteraMultiZoneRCCIBackUp_20130520(CasePara cp) {
//		super(cp);
//		try{
...
//		
//		i+=1;
//		super.buffer_EinzelErgebnis("TKE_M [m^2/s^2]", this.turb.get_k(time),i);
//
//		i+=1;
//		super.buffer_EinzelErgebnis("EPS_Kiva [m^2/s^3]", this.tfr.get_EPS(time),i);
//		
//		i+=1;
//		super.buffer_EinzelErgebnis("EPS_M [m^2/s^3]", this.turb.get_eps(time)/this.turb.get_turbulenceIntegralLengthScale(zn,time),i);
//
//		i+=1;
//		super.buffer_EinzelErgebnis("TI_Kiva [m/s]", this.tfr.get_TI(time),i);
//		
//		i+=1;
//		super.buffer_EinzelErgebnis("TI_M [m/s]", this.turb.get_intensity(time),i);
//		
//		i+=1;		
