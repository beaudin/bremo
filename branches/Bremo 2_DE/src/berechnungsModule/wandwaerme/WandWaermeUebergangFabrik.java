...
//			}
				...
				System.out.println("Mit diesem WWÜ wird die ursprüngliche Vorgehensweise nach Diss. Bargende gewählt."+
						"Alternativ kann BargendeFVV als WW-Modell ausgewählt werden");
...
//				if(isDVA_2Zonig.equals("DVA_2Zonig")){ //Bargende erstmal nur für DVA_2Zonig...
			...
			else if(wandwaermemodellVorgabe.equals("BargendeFVV")){
				System.out.println("Mit diesem WWÜ wird nach der Vorgehensweise der FVV gerechnet (S. Diss. Grill)."+
						"Alternativ kann Bargende als WW-Modell ausgewählt werden");
//				String isDVA_2Zonig=CP.MODUL_VORGABEN.get("berechnungsModell"); //Welches BerechnungsModell?
//				if(isDVA_2Zonig.equals("DVA_2Zonig")){ //Bargende erstmal nur für DVA_2Zonig...
				if(	CP.MODUL_VORGABEN.get("berechnungsModell").equals("DVA_1Zonig")|
					CP.MODUL_VORGABEN.get("berechnungsModell").equals("DVA_2Zonig")|
