...
public class ToolTipFrame extends JFrame {
    ...
    private void initComponents(String Titel, String message) {
        ...
        title.setIcon(new ImageIcon(ToolTipFrame.class.getResource("/bremoswing/bild/bremo1_18.png"))); 
        title.setText(Titel);
        title.setBorder(new LineBorder(new java.awt.Color(0, 0, 0), 1, true));

        textInfo.setFont(new Font("Comic Sans MS", 0, 14)); 
        textInfo.setBorder(BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(textInfo, GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(textInfo, GroupLayout.PREFERRED_SIZE, 80, GroupLayout.PREFERRED_SIZE))
        );
