...
public class FunktionsTester {
	...
	public void estimateEGR(){
		...
		Spezies ron= CP.SPEZIES_FABRIK.get_iC8H18();
		Spezies diesel= CP.SPEZIES_FABRIK.get_nC7H16();
		...
		GasGemisch krst=new GasGemisch("krst");
		...
		Spezies wasser=CP.SPEZIES_FABRIK.get_spezH2O();
		...
		GasGemisch airWet=new GasGemisch("gg");
		...
		do{
			...
			GasGemisch newGemisch=new GasGemisch("test");			
			newGemisch.set_Gasmischung_massenBruch(gemisch2_MassenbruchHash);
			xO2_new=newGemisch.get_speziesMolenBruecheDetailToIntegrate().get(CP.SPEZIES_FABRIK.get_spezO2());
			if(xO2_new>xO2Match){
				xEGRLow=xEGR;
...
//		T_set=366.55449;
		...
		GasGemisch gg_Ivc=new GasGemisch("ggIVC");
		double T_Ivc;
		do{		
			...
			ht.put(CP.SPEZIES_FABRIK.get_nC7H16(), mDiesel/mTotCombust);
			ht.put(CP.SPEZIES_FABRIK.get_iC8H18(), mGasoline/mTotCombust);
			ht.put(CP.SPEZIES_FABRIK.get_spezLuft_trocken(), mAirTrapped/mTotCombust);
			...
			if(detailedOutput){
				...
				htGG=HeizwertRechner.calcMolenBruechePerfekteVerbrennung(CP, gg);
			}

			GasGemisch egr=new GasGemisch("EGR");
			egr.set_Gasmischung_molenBruch(htGG);
			gg=null;

			//Gasmixture at IVC
			double mTotIvc=mAirTrapped+mGasoline+mEGR_Ex+mEGR_Int;		
			Hashtable<Spezies,Double> ht2=new Hashtable<Spezies,Double>();	
			ht2.put(CP.SPEZIES_FABRIK.get_iC8H18(), mGasoline/mTotIvc);
			ht2.put(CP.SPEZIES_FABRIK.get_spezLuft_trocken(), mAirTrapped/mTotIvc);
		...
		try{
			x_iC8H18=comp.get(CP.SPEZIES_FABRIK.get_iC8H18());	
		}catch (NullPointerException npe){}
		try{
			x_O2=comp.get(CP.SPEZIES_FABRIK.get_spezO2());	
		}catch (NullPointerException npe){}
		try{
			x_CO2=comp.get(CP.SPEZIES_FABRIK.get_spezCO2());	
		}catch (NullPointerException npe){}
		try{
			x_H2O=comp.get(CP.SPEZIES_FABRIK.get_spezH2O());	
		}catch (NullPointerException npe){}
		try{
			x_H2=comp.get(CP.SPEZIES_FABRIK.get_spezH2());		
		}catch (NullPointerException npe){}
		try{
			x_H=comp.get(CP.SPEZIES_FABRIK.get_spezH());		
		}catch (NullPointerException npe){}
		try{
			x_CO=comp.get(CP.SPEZIES_FABRIK.get_spezCO());	
		}catch (NullPointerException npe){}
		try{
			x_OH=comp.get(CP.SPEZIES_FABRIK.get_spezOH());	
		}catch (NullPointerException npe){}
		try{
			x_O=comp.get(CP.SPEZIES_FABRIK.get_spezO());	
		}catch (NullPointerException npe){}
		try{
			x_NO=comp.get(CP.SPEZIES_FABRIK.get_spezNO());	
		}catch (NullPointerException npe){}
		try{
			x_N=comp.get(CP.SPEZIES_FABRIK.get_spezN());	
		}catch (NullPointerException npe){}
		try{
			x_N2=comp.get(CP.SPEZIES_FABRIK.get_spezN2());
		}catch (NullPointerException npe){}	
...
//		und dass die Rechnung bei IVC startet
		...
		double moles_totIVC=p_Ivc*V_Ivc/PhysKonst.get_R_allg()/T_Ivc;
		double moles_iC8H18=mGasoline/CP.SPEZIES_FABRIK.get_iC8H18().get_M();
		double moles_nC7H16=mDiesel/CP.SPEZIES_FABRIK.get_nC7H16().get_M();
		double moles_air_egr=moles_totIVC-moles_iC8H18;
		double moles_egr=moles_air_egr*xrg;
		double moles_air=moles_air_egr*(1-xrg);
		double mAir=moles_air*CP.SPEZIES_FABRIK.get_spezLuft_trocken().get_M();
		
		double nft=moles_iC8H18+moles_nC7H16;
		double Mf=moles_iC8H18/nft*CP.SPEZIES_FABRIK.get_iC8H18().get_M()+moles_nC7H16/nft*CP.SPEZIES_FABRIK.get_nC7H16().get_M();
		
		
		//composition egr
		double moles_tot=moles_air+moles_nC7H16+moles_iC8H18;
		Hashtable<Spezies,Double> ht=new Hashtable<Spezies,Double>();
		ht.put(CP.SPEZIES_FABRIK.get_nC7H16(), moles_nC7H16/moles_tot);
		ht.put(CP.SPEZIES_FABRIK.get_iC8H18(), moles_iC8H18/moles_tot);
		ht.put(CP.SPEZIES_FABRIK.get_spezLuft_trocken(), moles_air/moles_tot);
		GasGemisch gg=new GasGemisch("gg");
		gg.set_Gasmischung_molenBruch(ht);
...
//		double ggR=gg.get_M();
		...
		//chk
		double xCO2_EGRCHK=htGG.get(CP.SPEZIES_FABRIK.get_spezCO2());
		double xH2O_EGRCHK=htGG.get(CP.SPEZIES_FABRIK.get_spezH2O());
		double xO2_EGRCHK=htGG.get(CP.SPEZIES_FABRIK.get_spezO2());		
		double xN2_EGRCHK=htGG.get(CP.SPEZIES_FABRIK.get_spezN2());
		
		double moles_o2=moles_air*PhysKonst.get_vol_O2_Luft()+xO2_EGR*moles_egr;
		double moles_co2=moles_air*PhysKonst.get_vol_CO2_Luft()+xCO2_EGR*moles_egr;
		double moles_h2o=xH2O_EGR*moles_egr;
		double moles_n2=moles_air*PhysKonst.get_vol_N2_Luft()+xN2_EGR*moles_egr;		
//		double moles_n2=moles_air-moles_o2;
	...
	public void testDieselMassFracion(){
		...
		GasGemisch gasMix=new GasGemisch("mixGas");
		gasMix.set_Gasmischung_molenBruch(ht);
		...
		Spezies nC7H16=CP.SPEZIES_FABRIK.get_nC7H16();		
		double molD=0;		
		double molG=1;		
		...
		Hashtable<Spezies, Double> ht2=new Hashtable<Spezies,Double>();
		GasGemisch dieslGasMix=new GasGemisch("gg");
		ht2.put(gasMix, molG/molTot);
		ht2.put(nC7H16, molD/molTot);
		dieslGasMix.set_Gasmischung_molenBruch(ht2);			
	...
	public void testTurbFileReader(){
		...
		double t1=CP.SYS.RECHNUNGS_ENDE_DVA_SEC;	
		double delta=(t1-t0)/CP.SYS.ANZ_BERECHNETER_WERTE;
		double test=t0+delta*CP.SYS.ANZ_BERECHNETER_WERTE;
		double t=t0;
		double data[][]=new double[4][CP.SYS.ANZ_BERECHNETER_WERTE];
		for(int i=0;i<CP.SYS.ANZ_BERECHNETER_WERTE;i++){
...
//		fw2.writeMatrixToFile(kpr.get_data(), false);
	...
	public void calcLambda4Comp(){	
		...
		compo.put(CP.SPEZIES_FABRIK.get_nC7H16(), mDiesel/mGes);
		GasGemisch mix=new GasGemisch("mix");
	...
	public void testDruckausgleichCantera(){
		...
		int a1=CP.SPEZIES_FABRIK.get_nbrOfSpecies();
		...
		GasGemisch [] specs=new GasGemisch[anzVol];
		Zone zones[]=new Zone[anzVol];

		Hashtable<Spezies, Double> ht=new Hashtable<Spezies,Double>();					
		ht.put(CP.SPEZIES_FABRIK.get_spezCO2(), 1D);		
		specs[0]=new GasGemisch("Gas1");
		...
		Hashtable<Spezies, Double> ht2=new Hashtable<Spezies,Double>();					
		ht2.put(CP.SPEZIES_FABRIK.get_spezN2(), 1D);		
		specs[1]=new GasGemisch("Gas2");
		...
		ht3.put(CP.SPEZIES_FABRIK.get_spezO2(), 1D);		
		specs[2]=new GasGemisch("Gas3");
	...
	public void testDruckausgleichDiffSysZones(){
		...
		do{			
			...
			for(int i=0;i<anzVol;i++){
				double T=V_T[i*2+1];
				double V=V_T[i*2];
				double p=m[i]*zones[i].get_ggZone().get_R()*T/V;				
				results[step][i*3+1]=p;
				results[step][i*3+2]=V;
				results[step][i*3+3]=T;		
				U=U+zones[i].get_ggZone().get_u_mass(T)*m[i];
				Vges=Vges+V;
			}	
			results[step][0]=t;	
			results[step][anzVol*3+1]=Vges;	
	...
	private class DruckAusgleicher implements DglSysFunction{
		private Zone[] zones;
	...
	public void testCantera(){
		...
		double result [][]=new double [nbrOfIterations][CP.SPEZIES_FABRIK.get_nbrOfSpecies()+4];
		...
		String header[]=new String [CP.SPEZIES_FABRIK.get_nbrOfSpecies()+4];
		header[0]="t";
		header[1]="p";
		header[2]="V";
		header[3]="T";
	...
	public void printMolarMasses(){		
		int nsp=CP.SPEZIES_FABRIK.get_nbrOfSpecies();
		double M[]=new double [nsp];


		for(int i=0; i<nsp;i++) 
			M[i]=CP.SPEZIES_FABRIK.get_Spez(i).get_M()*1000;


		String header[] =new String[nsp];
		for(int i=0; i<nsp;i++)			
			header[i]= CP.SPEZIES_FABRIK.get_Spez(i).get_name();	
	...
	public void testCantera3Zone(){
		...
		System.out.println("PHI zn2: "+ 1/zn[2].get_ggZone().get_lambda());
		System.out.println("Lambda zn2: "+zn[2].get_ggZone().get_lambda());
		System.out.println("Lambda zn3: "+zn[3].get_ggZone().get_lambda());
		...
		//cc.test();
		int totalSpecNbr=nbrOfZones*CP.SPEZIES_FABRIK.get_nbrOfSpecies();
		...
		for(int i=0;i<nbrOfIterations;i++){	
			...
			for(int z=0;z<zn.length;z++){
				...
				result[i][nbrOfZones*3+totalSpecNbr+1+1]=result[i][nbrOfZones*3+totalSpecNbr+1+1]
						+zn[z].get_ggZone().get_u_mass(zn[z].get_T())*zn[z].get_m();


				massen[i][z+1]=zn[z].get_m();
				massen[i][zn.length+1]=massen[i][zn.length+1]+zn[z].get_m();				
			}
			massen[i][zn.length+2]=zn[2].get_ggZone().get_lambda();
			massen[i][zn.length+3]=zn[3].get_ggZone().get_lambda();
			for(int idxZ=0;idxZ<nbrOfZones;idxZ++){
				double []mf=zn[idxZ].get_MassFractions();
				for(int idx=0;idx<mf.length;idx++)result[i][idx+nbrOfZones*3+1+idxZ*CP.SPEZIES_FABRIK.get_nbrOfSpecies()]=mf[idx];
			}			
		...
		for(int idxZ=0;idxZ<nbrOfZones;idxZ++)
			for(int i=0; i<CP.SPEZIES_FABRIK.get_nbrOfSpecies();i++) 
				header[nbrOfZones*3+1+idxZ*CP.SPEZIES_FABRIK.get_nbrOfSpecies()+i]=  cc.get_getNameOfSpecie(i)+ "_"+(idxZ+1);		
	...
	public void test_BremoCanteraSpeciesGasMix(){
		...
		GasGemisch gg=new GasGemisch("gg");
		gg.set_Gasmischung_molenBruch(molFrac);
	...
	public  void test_get_lambda(){
		...
		Spezies krst= CP.SPEZIES_FABRIK.get_nC7H16();
		Spezies luft=CP.SPEZIES_FABRIK.get_spezLuft_trocken();
		Spezies wasser=CP.SPEZIES_FABRIK.get_spezH2O();
		...
		GasGemisch gemischTr=new GasGemisch("gg");
		...
		GasGemisch abgas=new GasGemisch("Abgas");			
		abgas.set_Gasmischung_molenBruch(gg.get_GG_molenBrueche(1e5, 1000, gemisch)); 
		GasGemisch abgasTr=new GasGemisch("Abgas");			
		abgasTr.set_Gasmischung_molenBruch(gg.get_GG_molenBrueche(1e5, 1000, gemischTr)); 
		...
		GasGemisch gemisch2=new GasGemisch("gmisch2");
		gemisch2.set_Gasmischung_massenBruch(gemisch_MassenbruchHash2);
		
		//Verbrennen
		GasGemisch abgas2=new GasGemisch("Abgas");	
		abgas2.set_Gasmischung_molenBruch(gg.get_GG_molenBrueche(1e5, 1000, gemisch2)); 
