...
public class APR_CanteraMultiZoneHomogeneous_BackUp extends APR_Cantera {
	...
	protected APR_CanteraMultiZoneHomogeneous_BackUp(CasePara cp) {		
		super(cp);
	...
	private Zone [] init(){
		...
		Spezies krst=
				masterEinspritzung.get_spezKrst_verdampft(CP.SYS.SIMULATION_START_SEC,0);
		...
		//p Init
		double p_init=indiD.get_pZyl(CP.SYS.SIMULATION_START_SEC);
		//V Init
		...
		QbMax=masterEinspritzung.get_mFuel_Sum_Cycle()
				*masterEinspritzung.get_spezKrstALL().get_LHV_mass();		

		mGes=masterEinspritzung.get_mFuel_Sum_Cycle()+mVerbrennungsLuft;
	...
	private Zone [] initValidateCT(){
		...
		nbrOfZones=3;
		Zone [] zn=new Zone[nbrOfZones];		
		double [][] compVec = new double [3][CP.SPECIES_FACTROY.get_nbrOfSpecies()];
		...
		double [] y0=new double [CP.SPECIES_FACTROY.get_nbrOfSpecies()];
		y0[CP.SPECIES_FACTROY.get_indexOf(CP.SPECIES_FACTROY.get_CO2())]=1.0;
		compVec[0]=y0;


		double [] y1=new double [CP.SPECIES_FACTROY.get_nbrOfSpecies()];
		y1[CP.SPECIES_FACTROY.get_indexOf(CP.SPECIES_FACTROY.get_N2())]=1.0;
		compVec[1]=y1;

		double [] y2=new double [CP.SPECIES_FACTROY.get_nbrOfSpecies()];
	...
	private Zone [] initReadInHeatReleaseProfile(){			
		...
		y[CP.SPECIES_FACTROY.get_indexOf(CP.SPECIES_FACTROY.get_nC7H16())]=nC7H16;
		y[CP.SPECIES_FACTROY.get_indexOf(CP.SPECIES_FACTROY.get_O2())]=nO2;
		y[CP.SPECIES_FACTROY.get_indexOf(CP.SPECIES_FACTROY.get_N2())]=nN2;
		y[CP.SPECIES_FACTROY.get_indexOf(CP.SPECIES_FACTROY.get_CO2())]=nCO2;		
		y[CP.SPECIES_FACTROY.get_indexOf(CP.SPECIES_FACTROY.get_H2O())]=nH2O;
		y[CP.SPECIES_FACTROY.get_indexOf(CP.SPECIES_FACTROY.get_iC8H18())]=niC8H18;	
