...
import kalorik.Spezies;
	...
	public class ChemEquilibriumSolver_Olikara_Borman extends ChemEquilibriumSolver{
		
		protected ChemEquilibriumSolver_Olikara_Borman(CasePara cp,
...
//		}
		...
		public Hashtable<Spezies, Double> get_GG_molenBrueche(double p,
			...
			double fVol_CO2Luft=PhysConst.get_vol_CO2_Luft();
			double fVol_O2Luft=PhysConst.get_vol_O2_Luft();
			double fVol_N2Luft=PhysConst.get_vol_N2_Luft();
			double fVol_ArLuft = PhysConst.get_vol_Ar_Luft();
