...
public class FuelProperties {
	...
	public static String [] modelFuels={"ndodecane","tetradecane","diesel"};
	private CalcFuelProps krstProps;
	boolean vargaftik=false;
	
	public FuelProperties(String krstWahl){
		
		if(vargaftik)
			krstProps=new CalcFuelProps_Vargaftik(krstWahl);
		else
			krstProps=new CalcFuelProps_ohneQuelle(krstWahl);
	}
