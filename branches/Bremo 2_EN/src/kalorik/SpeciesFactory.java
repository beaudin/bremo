...
public class SpeciesFactory {		
	...
	public SpeciesFactory(CasePara cp, MakeMeUnique mmu){
	...
	private double calc_b1_low(double [][] thermodynKoeffs, double lhv, 
		...
		double b1=hf_Adapted/PhysConst.get_R_allg()-h;
	...
	private double calc_b1_high(double [][] thermodynKoeffs, double lhv, 
			double cAtoms, double hAtoms, double oAtoms){	
		double R_allg=PhysConst.get_R_allg();
	...
	private double calc_LHV(double cAtoms, double hAtoms, 
		...
		double x=cAtoms;
		double y=hAtoms;		
		double hf_O2=get_O2().get_delta_hf298_mol();
		double hf_CO2=get_CO2().get_delta_hf298_mol();
		double hf_H2O=get_H2O().get_delta_hf298_mol();
	...
	private void initializeCanteraSpecies(String speciesName){
		...
		if(speciesName.equalsIgnoreCase("H"))
			speciesByName.put(get_H().get_name(), get_H());		
		else if(speciesName.equalsIgnoreCase("O"))
			speciesByName.put(get_O().get_name(), get_O());
		else if(speciesName.equalsIgnoreCase("N"))
			speciesByName.put(get_N().get_name(), get_N());
		else if(speciesName.equalsIgnoreCase("H2"))
			speciesByName.put(get_H2().get_name(), get_H2());
		else if(speciesName.equalsIgnoreCase("OH"))
			speciesByName.put(get_OH().get_name(), get_OH());
		else if(speciesName.equalsIgnoreCase("CO"))
			speciesByName.put(get_CO().get_name(), get_CO());
		else if(speciesName.equalsIgnoreCase("NO"))
			speciesByName.put(get_NO().get_name(), get_NO());
		else if(speciesName.equalsIgnoreCase("O2"))
			speciesByName.put(get_O2().get_name(), get_O2());
		else if(speciesName.equalsIgnoreCase("H2O"))
			speciesByName.put(get_H2O().get_name(), get_H2O());
			...
			speciesByName.put(get_CO2().get_name(), get_CO2());
		else if(speciesName.equalsIgnoreCase("N2"))
			speciesByName.put(get_N2().get_name(), get_N2());
...
public Spezies get_SpeciesByName(String speciesName){
	 ...
	 */
	public Spezies get_H() {	

		if(spezH==null){		
			
			double koeffs [][]=new double [3][];

			if(CP.SYS.THERMO_POLYNOMIALS_COEFFS_USERCHOICE.equalsIgnoreCase("Burcat")){		
				koeffs[0] = Koeffs_Burcat.get_koeffs_H_l();
				koeffs[1]= Koeffs_Burcat.get_koeffs_H_h();
				koeffs[2]=Koeffs_Burcat.get_TemperaturGrenze();
			}else if(CP.SYS.THERMO_POLYNOMIALS_COEFFS_USERCHOICE.equalsIgnoreCase("NASA9")){
			...
			spezH=new CoefficientsSpecies(koeffs,hf,lhv,0,0,1,0,"H");	
...
//			this.integrierMich(spezH);
	...
	public Spezies get_O() {	
		...
		if(spezO==null){			
			...
			double hf=this.calc_deltaHf(koeffs);			
			spezO=new CoefficientsSpecies(koeffs,								
					hf,0,1,0,0,0,"O"); 
//			this.integrierMich(spezO);
	...
	public Spezies get_N() {
		...
		if(spezN==null){		
			...
			double hf=this.calc_deltaHf(koeffs);
			spezN=new CoefficientsSpecies(	koeffs,								
					hf,0,0,0,0,1,"N");
...
//			this.integrierMich(spezN);
	...
	public Spezies get_H2() {
		...
		if(spezH2==null){			
			...
			spezH2=new CoefficientsSpecies(koeffs,hf,lhv,0,0,2,0,"H2");
...
//			this.integrierMich(spezH2);
	...
	public Spezies get_OH() {
		...
		if(spezOH==null){
			...
			double hf=this.calc_deltaHf(koeffs);			
			spezOH=new CoefficientsSpecies(koeffs, hf, 0, 1, 0, 1, 0, "OH");			
//			this.integrierMich(spezOH);
	...
	public Spezies get_CO() {		
		if(spezCO==null){
			...
			spezCO=new CoefficientsSpecies(koeffs,hf,hu,1,1,0,0,"CO"); 			
//			this.integrierMich(spezCO);
	...
	public Spezies get_NO() {
		...
		if(spezNO==null){			
			...
			double hf=this.calc_deltaHf(koeffs);			
			spezNO=new CoefficientsSpecies(koeffs,hf,0,1,0,0,1,"NO");			
//			this.integrierMich(spezNO);
	...
	public Spezies get_O2() {
		...
		if(spezO2==null){
			...
			double hf=this.calc_deltaHf(koeffs);
			spezO2=new CoefficientsSpecies(koeffs,hf,0,2,0,0,0,"O2");			
//			this.integrierMich(spezO2);
	...
	public Spezies get_H2O() {
		...
		if(spezH2O==null){
			...
			double hf=this.calc_deltaHf(koeffs);
			double lhv=0;
			spezH2O=new CoefficientsSpecies(koeffs,hf,lhv,1,0,2,0,"H2O");			
//			this.integrierMich(spezH2O);
	...
	public Spezies get_CO2() {
		...
		if(spezCO2==null){
			...
			double hf=this.calc_deltaHf(koeffs);
			double lhv=0;			
			spezCO2=new CoefficientsSpecies(koeffs,hf,lhv,2,1,0,0,"CO2");			
//			this.integrierMich(spezCO2);
	...
	public Spezies get_N2() {
		...
		if(spezN2==null){
			...
			spezN2=new CoefficientsSpecies(koeffs,hf,lhv,0,0,0,2,"N2");			
...
//				spezAr=new KoeffizientenSpezies(koeffs,hf,lhv,0,0,0,0,"Ar");
	...
	/**
		...
		public Spezies get_spezLuft_trocken() {
			if(spezLuftTr==null){
				...
				double vol_O2=PhysConst.get_vol_O2_Luft();
				koeffSpeziesMolenBruchHash.put((CoefficientsSpecies) get_O2(),vol_O2 );
				double vol_CO2=PhysConst.get_vol_CO2_Luft();
				koeffSpeziesMolenBruchHash.put((CoefficientsSpecies) get_CO2(),vol_CO2 );
	...
	//			von Ar dann zu unstimmigen Massenbruechen fuehren wuerde
				koeffSpeziesMolenBruchHash.put((CoefficientsSpecies) get_N2(), vol_N2);	
				spezLuftTr=new GasMixture("Luft");
				((GasMixture)spezLuftTr).set_Gasmixture_moleFracs(koeffSpeziesMolenBruchHash);
			}
			return spezLuftTr;
		}
	...
	public Spezies get_spezC2H5OH() {		
		if(spezC2H5OH==null){			
			...
			spezC2H5OH=new CoefficientsSpecies(koeffs,hf,lhv,1,2,6,0,"Ethanol");
		}
		return spezC2H5OH;
	}
...
//			hf=this.calc_hf4LHV(7, 16, 0, lhv);
			...
			nC7H16=new CoefficientsSpecies(koeffs,hf,lhv,0,7,16,0,"nC7H16");
//			this.integrierMich(nC7H16);
			
			//adapting factor b1 in the NASA-Polinomials to generate the appropriate LHV			
			double lhvMJkg=nC7H16.get_LHV_mass()*1e-6; //orig: 44.91677864661398
...
//			me.log_Warning();
		...
		if(nC14H30==null){			
			...
			nC14H30=new CoefficientsSpecies(koeffs,hf,lhv,0,14,30,0,"nC14H30");
	...
	public Spezies get_H2O2() {		
		if(H2O2==null){			
			...
			H2O2=new CoefficientsSpecies(koeffs,hf,lhv,2,0,2,0,"H2O2");
//			this.integrierMich(H2O2);
	...
	public Spezies get_HO2() {		
		if(HO2==null){			
			...
			HO2=new CoefficientsSpecies(koeffs,hf,lhv,2,0,1,0,"HO2");
//			this.integrierMich(HO2);
	...
	public Spezies get_CH3O() {		
		if(CH3O==null){			
			...
			CH3O=new CoefficientsSpecies(koeffs,hf,lhv,1,1,3,0,"CH3O");
//			this.integrierMich(CH3O);
	...
	public Spezies get_CH2O() {		
		if(CH2O==null){			
			...
			CH2O=new CoefficientsSpecies(koeffs,hf,lhv,1,1,2,0,"CH2O");
//			this.integrierMich(CH2O);
	...
	public Spezies get_HCO() {		
		if(HCO==null){			
			...
			HCO=new CoefficientsSpecies(koeffs,hf,lhv,1,1,1,0,"HCO");
//			this.integrierMich(HCO);
	...
	public Spezies get_CH2() {		
		if(CH2==null){			
			...
			CH2=new CoefficientsSpecies(koeffs,hf,lhv,0,1,2,0,"CH2");
//			this.integrierMich(CH2);
	...
	public Spezies get_CH3() {		
		if(CH3==null){			
			...
			CH3=new CoefficientsSpecies(koeffs,hf,lhv,0,1,3,0,"CH3");
//			this.integrierMich(CH3);
	...
	public Spezies get_CH4() {		
		if(CH4==null){			
			...
			CH4=new CoefficientsSpecies(koeffs,hf,lhv,0,1,4,0,"CH4");
//			this.integrierMich(CH4);
	...
	public Spezies get_C2H2() {		
		if(C2H2==null){			
			...
			C2H2=new CoefficientsSpecies(koeffs,hf,lhv,0,2,2,0,"C2H2");
//			this.integrierMich(C2H2);
	...
	public Spezies get_C2H3() {		
		if(C2H3==null){			
			...
			C2H3=new CoefficientsSpecies(koeffs,hf,lhv,0,2,3,0,"C2H3");
//			this.integrierMich(C2H3);
	...
	public Spezies get_C2H4() {		
		if(C2H4==null){			
			...
			C2H4=new CoefficientsSpecies(koeffs,hf,lhv,0,2,4,0,"C2H4");
//			this.integrierMich(C2H4);
	...
	public Spezies get_C2H5() {		
		if(C2H5==null){			
			...
			double hf=this.calc_deltaHf(koeffs);
			double lhv=this.calc_LHV(2,5,0,hf);	
			C2H5=new CoefficientsSpecies(koeffs,hf,lhv,0,2,5,0,"C2H5");
//			this.integrierMich(C2H5);
	...
	public Spezies get_C3H4() {		
		if(C3H4==null){			
			...
			C3H4=new CoefficientsSpecies(koeffs,hf,lhv,0,3,4,0,"C3H4");
//			this.integrierMich(C3H4);
	...
	public Spezies get_C3H5() {		
		if(C3H5==null){			
			...
			C3H5=new CoefficientsSpecies(koeffs,hf,lhv,0,3,5,0,"C3H5");
//			this.integrierMich(C3H5);
	...
	public Spezies get_C3H6() {		
		if(C3H6==null){			
			...
			C3H6=new CoefficientsSpecies(koeffs,hf,lhv,0,3,6,0,"C3H6");
//			this.integrierMich(C3H6);
	...
	public Spezies get_C3H7() {		
		if(C3H7==null){			
			...
			C3H7=new CoefficientsSpecies(koeffs,hf,lhv,0,3,7,0,"C3H7");
//			this.integrierMich(C3H7);
	...
	public Spezies get_C7H15_2() {		
		if(C7H15_2==null){			
			...
			C7H15_2=new CoefficientsSpecies(koeffs,hf,lhv,0,7,15,0,"C7H15-2");
//			this.integrierMich(C7H15_2);
	...
	public Spezies get_C7H15O2() {		
		if(C7H15O2==null){			
			...
			C7H15O2=new CoefficientsSpecies(koeffs,hf,lhv,2,7,15,0,"C7H15O2");
//			this.integrierMich(C7H15O2);
	...
	public Spezies get_C7KET12() {		
		if(C7KET12==null){			
			...
			C7KET12=new CoefficientsSpecies(koeffs,hf,lhv,3,7,14,0,"C7KET12");
//			this.integrierMich(C7KET12);
	...
	public Spezies get_C5H11CO() {		
		if(C5H11CO==null){			
			...
			C5H11CO=new CoefficientsSpecies(koeffs,hf,lhv,1,6,11,0,"C5H11CO");
//			this.integrierMich(C5H11CO);
	...
	public Spezies get_N2O() {		
		if(N2O==null){			
			...
			N2O=new CoefficientsSpecies(koeffs,hf,lhv,1,0,0,2,"N2O");
//			this.integrierMich(N2O);
	...
	public Spezies get_NO2() {		
		if(NO2==null){			
			...
			NO2=new CoefficientsSpecies(koeffs,hf,lhv,2,0,0,1,"NO2");
...
//			hf=this.calc_hf4LHV(8,18,0, lhv);
			iC8H18=new CoefficientsSpecies(koeffs,hf,lhv,0,8,18,0,"iC8H18");			
//			this.integrierMich(iC8H18);
			
			//adapting factor b1 in the NASA-Polinomials to generate the appropriate LHV
			double lhvMJkg=iC8H18.get_LHV_mass()*1e-6;
	...
	public Spezies get_C8H17() {		
		if(C8H17==null){			
			...
			C8H17=new CoefficientsSpecies(koeffs,hf,lhv,0,8,17,0,"C8H17");
//			this.integrierMich(C8H17);
	...
	public Spezies get_C8H17OO() {		
		if(C8H17OO==null){			
			...
			C8H17OO=new CoefficientsSpecies(koeffs,hf,lhv,2,8,17,0,"C8H17OO");
//			this.integrierMich(C8H17OO);
	...
	public Spezies get_iC8KET21() {		
		if(iC8KET21==null){			
			...
			iC8KET21=new CoefficientsSpecies(koeffs,hf,lhv,3,8,16,0,"iC8KET21");
//			this.integrierMich(iC8KET21);
	...
	public Spezies get_C6H13CO() {		
		if(C6H13CO==null){			
			...
			C6H13CO=new CoefficientsSpecies(koeffs,hf,lhv,1,7,13,0,"C6H13CO");
//			this.integrierMich(C6H13CO);
	...
	public Spezies get_C4H9() {		
		if(C4H9==null){			
			...
			C4H9=new CoefficientsSpecies(koeffs,hf,lhv,0,4,9,0,"C4H9");
//			this.integrierMich(C4H9);
	...
	public Spezies get_C2H6() {		
		if(C2H6==null){			
			...
			C2H6=new CoefficientsSpecies(koeffs,hf,lhv,0,2,6,0,"C2H6");
//			this.integrierMich(C2H6);
	...
	public Spezies get_CH2CHO() {		
		if(CH2CHO==null){			
			...
			CH2CHO=new CoefficientsSpecies(koeffs,hf,lhv,1,2,3,0,"CH2CHO");
//			this.integrierMich(CH2CHO);
	...
	public Spezies get_CH2CO() {		
		if(CH2CO==null){			
			...
			CH2CO=new CoefficientsSpecies(koeffs,hf,lhv,1,2,2,0,"CH2CO");
//			this.integrierMich(CH2CO);
	...
	public Spezies get_CH3O2() {		
		if(CH3O2==null){			
			...
			CH3O2=new CoefficientsSpecies(koeffs,hf,lhv,2,1,3,0,"CH3O2");
//			this.integrierMich(CH3O2);
	...
	public Spezies get_CH3O2H() {		
		if(CH3O2H==null){			
			...
			CH3O2H=new CoefficientsSpecies(koeffs,hf,lhv,2,1,4,0,"CH3O2H");
//			this.integrierMich(CH3O2H);
	...
	public Spezies get_soot() {		
		if(soot==null){			
			...
			soot=new CoefficientsSpecies(koeffs,hf,lhv,0,80,0,0,"soot");
//			this.integrierMich(soot);
	...
	public Spezies get_NOx() {		
		if(NOx==null){			
			...
			double hf=this.calc_deltaHf(koeffs);
			double lhv=this.calc_LHV(0,0,0,hf);	
			NOx=new CoefficientsSpecies(koeffs,hf,lhv,1,0,0,1,"NOx");
//			this.integrierMich(soot);
		}
		return NOx;
	}	
	...
	public Spezies get_spezRON_91() {	
		...
		if(spezRON_91==null){			
			...
			spezRON_91=new CoefficientsSpecies(koeffs,
	...
	public Spezies get_spezRON_95() {
		...
		if(spezRON_95==null){
			...
			spezRON_95=new CoefficientsSpecies(koeffs,								
	...
	public Spezies get_spezRON_98() {
		...
		if(spezRON_98==null){
			...
			spezRON_98=new CoefficientsSpecies(koeffs,	
	...
	public Spezies get_spezDiesel() {
		...
		if(spezDiesel==null){
			...
			koeffs[2]=Koeffs_KrstFVV.get_TemperaturGrenze();
			spezDiesel=new CoefficientsSpecies(koeffs,hf,
