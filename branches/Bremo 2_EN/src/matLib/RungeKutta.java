...
public class RungeKutta{
        ...
        // Non-static method
        public double fourthOrder(DifferentialEquation g){
    	...
    	// Static method
	    public static double fourthOrder(DifferentialEquation g, double x0, double y0, double xn, double h){
    	...
    	// Non-static method
	    public double[] fourthOrder(DiefferetialEqationSys g){
            if(Double.isNaN(this.x0))throw new IllegalArgumentException("No initial x value has been entered");
            if(Double.isNaN(this.xn))throw new IllegalArgumentException("No final x value has been entered");
    	...
    	// Static method
	    public static double[] fourthOrder(DiefferetialEqationSys g, double x0, double[] y0, double xn, double h){
    	...
    	// Non-static method
    	public double cashKarp(DifferentialEquation g){
    	    if(Double.isNaN(this.x0))throw new IllegalArgumentException("No initial x value has been entered");
            if(Double.isNaN(this.xn))throw new IllegalArgumentException("No final x value has been entered");
            if(Double.isNaN(this.y0))throw new IllegalArgumentException("No initial y value has been entered");
            if(Double.isNaN(this.step))throw new IllegalArgumentException("No step size has been entered");
    	...
    	// Runge-Kutta-Cash-Karp for a single ordinary differential equation (ODE)
    	// Static method
    	public static double cashKarp(DifferentialEquation g, double x0, double y0, double xn, double h, double absTol, double relTol, int maxIter){
    	...
    	public static double cashKarp(DifferentialEquation g, double x0, double y0, double xn, double h, double absTol, double relTol){
   	    ...
   	    // Non-static method
    	public double[] cashKarp(DiefferetialEqationSys g){
    	    if(Double.isNaN(this.x0))throw new IllegalArgumentException("No initial x value has been entered");
            if(Double.isNaN(this.xn))throw new IllegalArgumentException("No final x value has been entered");
            if(this.yy0==null)throw new IllegalArgumentException("No initial y values have been entered");
            if(Double.isNaN(this.step))throw new IllegalArgumentException("No step size has been entered");
    	...
    	// Runge-Kutta-Cash-Karp for n ordinary differential equations (ODEs)
    	// Static method
    	public static double[] cashKarp(DiefferetialEqationSys g, double x0, double[] y0, double xn, double h, double absTol, double relTol, int maxIter){
    	...
    	public static double[] cashKarp(DiefferetialEqationSys g, double x0, double[] y0, double xn, double h, double absTol, double relTol){
    	...
    	// Non-static method
    	public double fehlberg(DifferentialEquation g){
    	    if(Double.isNaN(this.x0))throw new IllegalArgumentException("No initial x value has been entered");
            if(Double.isNaN(this.xn))throw new IllegalArgumentException("No final x value has been entered");
            if(Double.isNaN(this.y0))throw new IllegalArgumentException("No initial y value has been entered");
            if(Double.isNaN(this.step))throw new IllegalArgumentException("No step size has been entered");
        ...
        // Runge-Kutta-Fehlberg for a single ordinary differential equation (ODE)
    	// Static method
    	public static double fehlberg(DifferentialEquation g, double x0, double y0, double xn, double h, double absTol, double relTol, int maxIter){
           	RungeKutta rk = new RungeKutta();
	        rk.setInitialValueOfX(x0);
	        rk.setFinalValueOfX(xn);
	        rk.setInitialValueOfY(y0);
    	...
    	// Maximum iteration default option
    	// Static method
    	public static double fehlberg(DifferentialEquation g, double x0, double y0, double xn, double h, double absTol, double relTol){
    	...
    	// Non-static method
    	public double[] fehlberg(DiefferetialEqationSys g){
            if(Double.isNaN(this.x0))throw new IllegalArgumentException("No initial x value has been entered");
            if(Double.isNaN(this.xn))throw new IllegalArgumentException("No final x value has been entered");
            if(this.yy0==null)throw new IllegalArgumentException("No initial y values have been entered");
            if(Double.isNaN(this.step))throw new IllegalArgumentException("No step size has been entered");
    	...
    	// Static method
    	public static double[] fehlberg(DiefferetialEqationSys g, double x0, double[] y0, double xn, double h, double absTol, double relTol, int maxIter){
    	...
    	// Static method
    	// maximum iteration default option
    	public static double[] fehlberg(DiefferetialEqationSys g, double x0, double[] y0, double xn, double h, double absTol, double relTol){
