...
public class LHV_Calculator {

	private LHV_Calculator(){
	}	
	...
	public static double calcHup_perfekt(CasePara cp, Spezies krst){
		...
		double hf_O2=cp.SPECIES_FACTROY.get_O2().get_delta_hf298_mol();
		double hf_CO2=cp.SPECIES_FACTROY.get_CO2().get_delta_hf298_mol();
		double hf_H2O=cp.SPECIES_FACTROY.get_H2O().get_delta_hf298_mol();
	...
	public static double calcHup_perfekt(CasePara cp,Spezies krst, double bezugsTemp){
		...
		gemisch_MassenbruchHash.put(cp.SPECIES_FACTROY.get_spezLuft_trocken(), mL_tr/m_ges);		
		GasMixture gemisch=new GasMixture("Gemisch");
		...
		GasMixture abgas=new GasMixture(calcMolenBruechePerfekteVerbrennung(cp,krst,lambda),"Gemisch");
	...
	public static double calcHup_chemGLGW(CasePara cp, Spezies krst, double bezugsTemp, double lambda, double bezugsDruck){			
		...
		gemisch.set_Gasmixture_moleFracs(gg.get_GG_molenBrueche(bezugsDruck, bezugsTemp, gemisch));
	...
	public static double calcGemischHeizwert_chemGLGW_mass(
		...
		abgas.set_Gasmixture_moleFracs(gg.get_GG_molenBrueche(bezugsDruck, bezugsTemp, gemisch));
	...
	public static Hashtable<Spezies,Double>calcMolenBruechePerfekteVerbrennung(
		...
		double y=krst.get_AnzH_Atome();		
		double o2min=krst.get_O2_min();	
		double _N2_O2=PhysConst.get_vol_N2_Luft()/PhysConst.get_vol_O2_Luft();
		double _CO2_O2=PhysConst.get_vol_CO2_Luft()/PhysConst.get_vol_O2_Luft();
		...
		abgas_MolenbruchHash.put(cp.SPECIES_FACTROY.get_CO2(),mb_CO2);
		abgas_MolenbruchHash.put(cp.SPECIES_FACTROY.get_H2O(),mb_H2O);
		abgas_MolenbruchHash.put(cp.SPECIES_FACTROY.get_N2(),mb_N2);
		abgas_MolenbruchHash.put(cp.SPECIES_FACTROY.get_O2(),mb_O2);	
	...
	public static Hashtable<Spezies,Double>calcMolenBruechePerfekteVerbrennung(
		...
		Hashtable<Spezies,Double> abgas_MolenbruchHash=new Hashtable<Spezies,Double>();
		abgas_MolenbruchHash.put(cp.SPECIES_FACTROY.get_CO2(),e/moleAbgas);
		abgas_MolenbruchHash.put(cp.SPECIES_FACTROY.get_H2O(),f/moleAbgas);
		abgas_MolenbruchHash.put(cp.SPECIES_FACTROY.get_N2(),g/moleAbgas);
		abgas_MolenbruchHash.put(cp.SPECIES_FACTROY.get_O2(),i/moleAbgas);	
	...
	public static double calcadiabateFlammenTempPerfekt(CasePara cp,Spezies krst, double T, double lambda){	
		if(krst.get_LHV_mass()<=0){
			...
			GasMixture abgas=new GasMixture("Abgas");	
			abgas.set_Gasmixture_moleFracs(calcMolenBruechePerfekteVerbrennung(cp,krst,lambda));	
	...
	public static double calcadiabateFlammenTempPerfekt(CasePara cp,Spezies gemisch, double T){	
		...
		double hu=gemisch.get_LHV_mass()+gemisch.get_h_h298_mass(T);	
		GasMixture abgas=new GasMixture("Abgas");	
		abgas.set_Gasmixture_moleFracs(calcMolenBruechePerfekteVerbrennung(cp,gemisch));			
	...
	public static double calcAdiabateFlammenTemp(
			...
			do{
				Tb=(To+Tu)/2;							
				abgas.set_Gasmixture_moleFracs(gg.get_GG_molenBrueche(p, Tb, lambda, 
													krst.get_AnzC_Atome(), 
													krst.get_AnzH_Atome(), 
													krst.get_AnzO_Atome(), 
													krst.get_AnzN_Atome()));
...
//		To=calcadiabateFlammenTempPerfekt(gemisch, T); 
		...
		do{
			Tb=(To+Tu)/2;
			abgas.set_Gasmixture_moleFracs(gg.get_GG_molenBrueche(p, Tb, gemisch));
