...
//			double a=CP.convert_SEC2KW(time);
		...
		//Wenn die Ottozone weniger als die minimale Zonenmasse enth‰lt, wird sie der Dieselzone zugemischt, oder ausgeblendet.
...
//		Hashtable<Spezies,Double> ht4=zonen_IN[0].get_ggZone().get_speziesMassenBruecheDetailToIntegrate();
	...
	*/
	...
	private void zoneAusblenden(Zone zAusblenden, Zone zAndereZone, Zone zVerbrannteZone) {
		...
		//Wenn Masse und Volumen >0 und andere Zone bereits ausgeblendet, dann Wegfall von Volumen und Masse durch Hinzuf¸gen
