...
public class Verdampfung_2 implements DglSysFunction{
	...
	public Verdampfung_2(Kraftstoff_Eigenschaften krstEigenschaften){
		rk=new RungeKutta();		
			...
			double [] m_D_T)//Anfangswerte zum Zeitpunkt Null
	{
		...
		m_D_T_p_T_cp_M_v[5]=zn.get_ggZone().get_cp_mass(T_grenz);
