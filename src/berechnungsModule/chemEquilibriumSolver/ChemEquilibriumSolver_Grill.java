...
public class ChemEquilibriumSolver_Grill extends ChemEquilibriumSolver{	
	...
	protected ChemEquilibriumSolver_Grill(CasePara cp,String gleichGewichtsKonstantenVorgabe, double T_freeze){
...
//		}		
	...
	public Hashtable<Spezies, Double> get_GG_molenBrueche(	double p_, 
		...
		double vol_CO2_Luft=PhysConst.get_vol_CO2_Luft();
		double vol_O2_Luft=PhysConst.get_vol_O2_Luft();
		double vol_N2_Luft=PhysConst.get_vol_N2_Luft();
		double vol_Ar_Luft =PhysConst.get_vol_Ar_Luft();			
