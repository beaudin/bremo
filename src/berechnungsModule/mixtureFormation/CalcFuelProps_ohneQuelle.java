...
public class CalcFuelProps_ohneQuelle extends CalcFuelProps{
	private String krstWahl;		

	
	public CalcFuelProps_ohneQuelle(String krstWahl){
		super();
	...
	public double get_M_krst(){
		double M_krst=-1;
		if(krstWahl.equalsIgnoreCase("ndodecane"))  
    		M_krst=get_M_ndodecan();
		else if(krstWahl.equalsIgnoreCase("tetradecane"))
