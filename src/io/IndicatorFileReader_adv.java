...
public class IndicatorFileReader_adv extends IndicatorFileReader{
	...
	public IndicatorFileReader_adv (CasePara cp,String fileName,
			int kanal_pZyl,
			int kanal_pEin,
			int kanal_pAus){
	...
	public IndicatorFileReader_adv(CasePara cp,String fileName,int kanal_pZyl){
		super(cp);
		dreiDruecke=false;
		spalte_pZyl = kanal_pZyl;
