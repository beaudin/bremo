...
public class ValveLiftFileReader {
	...
	public ValveLiftFileReader(CasePara CP, String typ){		
//		try{
...
//		}
		...
		if(typ.equalsIgnoreCase("Einlass")){
			...
			offsetKW=cp.get_IVO_CA();
			offsetSEC=cp.get_IVO();
	...
	public double get_Hub(double time) {
		...
		double dauerASP_SEC=cp.SYS.CYCLE_DURATION_SEC;
