 ...
 */
public class CoefficientsSpecies extends Spezies {
	 ...
	 * @param name
	 */
	protected CoefficientsSpecies(double [][]thermodynKoeffs,					
		...
		this.name=name;
		this.molarWeight=this.anzC_Atome*PhysConst.get_M_C()+
				this.anzH_Atome*PhysConst.get_M_H()+
				this.anzN_Atome*PhysConst.get_M_N()+
				this.anzO_Atome*PhysConst.get_M_O();
