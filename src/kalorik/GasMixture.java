...
public class GasMixture extends Spezies {
	...
	public GasMixture(String name){				
		super();
		this.name=name;		
	}
	
	
	public GasMixture(Hashtable<Spezies,Double> speziesMolenBruchHash, String name) {	
		super();
	...
	berechne_DetailMolenbrueche(Hashtable<Spezies,Double>speziesMolenBruchHash){
		...
		while(e1.hasMoreElements()){
			...
			if(spez1.isGasGemisch==true){
				...
				Hashtable<Spezies,Double> molenbruchHash2=((GasMixture)spez1).get_speziesMolenBruecheDetail();
			...
			while(e1.hasMoreElements()){
				...
				if(spez1.isGasGemisch==true&&!spez1.isToIntegrate){
					...
					Hashtable<Spezies,Double> molenbruchHash2=
						Gasmischer.massenBruch2molenBruch(((GasMixture)spez1).get_speziesMassenBruecheDetailToIntegrate());
					Enumeration<Spezies> e2;
					e2=molenbruchHash2.keys();
					while(e2.hasMoreElements()){
						spez2=e2.nextElement();
	...
	public void set_Gasmixture_moleFracs(Hashtable<Spezies,Double> speziesMolenBruchHash) {
		erzeugeGasGemsich(speziesMolenBruchHash,name);	
	}
	...
	public Hashtable<Spezies, Double> get_speciesMassFracs(){
...
//		CxHyOz+LAM*(x+y/4-z/2)*(O2+3,773N2)-->...
		double a=PhysConst.get_vol_N2_Luft()/PhysConst.get_vol_O2_Luft();
		double b=PhysConst.get_vol_CO2_Luft()/PhysConst.get_vol_O2_Luft();
		double d=1+b;
