...
public abstract class Spezies {	
	...
	protected final double R_allg = PhysConst.get_R_allg();		// J/mol K	
	...
	public double get_Lst() {
		...
		if (O2min>0){
			return O2min*PhysConst.get_M_O2()/get_M()/PhysConst.get_mass_O2_Luft();
		}
		else {
			try{
				throw new MiscException("This Species can't be burned. " +
