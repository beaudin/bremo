...
public class Kraftstoff_Eigenschaften {
     ...
     */
    public double get_mue_krst(){
		double mue_krst=-1;
		if(krstWahl.equalsIgnoreCase("ndodecan"))  
    		mue_krst=get_mue_ndodecan();
		else if(krstWahl.equalsIgnoreCase("tetradecan"))
    		mue_krst=get_mue_tetradecan();
		else if(krstWahl.equalsIgnoreCase("Diesel"))
    ...
    private double get_mue_tetradecan(){
	...
	/**
	 * liefert waermekapazitaet von Kraftstoff in J/Kg/K
	 * @param T_tropfen
	 * @return
	 */
	public double get_cpf(double T_tropfen){		
		double cpf=-1;     	
    	if(krstWahl.equalsIgnoreCase("ndodecan"))  
	 ...
	 * @return
	 */
	public double get_k(double T_tropfen){		
		double k=-1; 
		if(krstWahl.equalsIgnoreCase("ndodecan"))
	...
	private double get_k_nheptan(double T_tropfen){
		...
		if (T_tropfen<540.17)
	    	...
	    	//TODO Berechnugsformel fuer hoehere Temperaturen einfuegen
	    	 k_nheptan=0.25844890110-4.5549450549e-4*T_tropfen;
		}
